    ...
    public function resignter(Request $request)
    {
        ...
        if($validate)
        {
            ...
            $sql = "DECLARE
                n NUMBER;
            BEGIN
                n:=THEM_TK_TB_ND('thaibinh161123','$2y$10$6M.ik7pD3JCJAyMJ2Tndh.F3JFdqrpL5N4OCBUfIT/6nbgvwEHqKG');
            END;";
            $pdo = DB::getPdo();
            ...
            $resignter = DB::select("select THEM_TK_TB_ND('thaibinh161','$2y$10$6M.ik7pD3JCJAyMJ2Tndh.F3JFdqrpL5N4OCBUfIT/6nbgvwEHqKG') from dual;");

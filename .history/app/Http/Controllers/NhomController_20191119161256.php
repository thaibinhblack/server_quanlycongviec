...
class NhomController extends Controller
{
    ...
    public function CallFunction($p_id_tt, $p_ten_nhom, $p_trang_thai_nhom, $p_ghi_chu_nhom, $p_mo_ta_nhom,$p_kiem_tra_action,$p_id_nhom)
    {
        $pdo = DB::getPdo();
        $sql = "DECLARE
    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            ...
            $p_kiem_tra_action = 1;
            $p_id_nhom = 0; 
            $result = $this->CallFunction($p_id_tt, $p_ten_nhom, $p_trang_thai_nhom, $p_ghi_chu_nhom, $p_mo_ta_nhom,$p_kiem_tra_action,$p_id_nhom);

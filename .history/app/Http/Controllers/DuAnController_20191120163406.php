    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            if($request->has('api_token'))
            {
                ...
                $P_MO_TA_DU_AN = $request->get('P_MO_TA_LOAI_DU_AN') != 'undefined' ? $request->get('P_MO_TA_LOAI_DU_AN') : 'NULL' ;
                ...
                $P_ACTION = 1;
                $result = $this->CallFunction($P_ID_DU_AN, $P_ID_LOAI_DU_AN, $P_TEN_DU_AN, $P_MO_TA_DU_AN, $P_GHI_CHU_DU_AN, $P_TRANG_THAI_DU_AN, $P_ID_KHACH_HANG, $P_ACTIONN);

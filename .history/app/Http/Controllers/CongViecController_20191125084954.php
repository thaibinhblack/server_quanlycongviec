    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            if($request->has('api_token'))
            {
                ...
                $P_NGAY_HOAN_THANH = new DateTime($request->get('P_NGAY_HOAN_THANH'));
                $P_NGUOI_GIAO_VIEC = new DateTime($request->get('P_NGUOI_GIAO_VIEC'));
                ...
                $P_NGAY_CAM_KET = $request->get('P_NGAY_CAM_KET') != 'undefined' ? new DateTime($request->get('P_NGAY_CAM_KET')) : NULL; 

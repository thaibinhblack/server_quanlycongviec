...
class NhomController extends Controller
{
    ...
    {
        $groups = DB::select("SELECT NHOM.*,TT.TEN_TT FROM TB_NHOM NHOM, TB_TRUNG_TAM TT where NHOM.ID_TT = TT.ID_TT");
    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            ...
            BEGIN
                :result := THEM_PHONG_BAN(:p_id_tt, :p_ten_nhom,:p_ghi_chu_nhom,:p_trang_thai_nhom,:p_mo_ta_nhom);
            END;";

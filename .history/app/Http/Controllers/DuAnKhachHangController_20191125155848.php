...
{
    public function CallFunction($P_ID_DU_AN_KH, $P_ID_DU_AN, $P_TEN_DU_AN, $P_MO_TA_DU_AN, $P_GHI_CHU_DU_AN, $P_TRANG_THAI_DU_AN, $P_ID_KHACH_HANG, $P_ACTION)
    {
        $sql = "DECLARE
            ...
            P_ACTION NUMBER(1);
        BEGIN
            :n := THEM_UPDATE_DU_AN_KH(:P_ID_DU_AN_KH, :P_ID_DU_AN, :P_TEN_DU_AN, :P_MO_TA_DU_AN, :P_GHI_CHU_DU_AN,:P_TRANG_THAI_DU_AN, :P_ID_KHACH_HANG, :P_ACTION);
        END;";  
        $pdo = DB::getPdo();
        $stmt = $pdo->prepare($sql);
        $stmt->bindParam(':P_ID_DU_AN',$P_ID_DU_AN_KH);
        $stmt->bindParam(':P_ID_LOAI_DU_AN',$P_ID_DU_AN);
    ...
    public function index(Request $request)
    {
        ...
        {
            //CHECK TOKEN
            $du_an = DB::SELECT("SELECT DA.*, LOAI_DA.TEN_LOAI_DU_AN, KH.TEN_KH, KH.ID_KHACH_HANG FROM TB_DU_AN DA, TB_LOAI_DA LOAI_DA, TB_KH KH
            WHERE DA.ID_LOAI_DU_AN = LOAI_DA.ID_LOAI_DU_AN AND DA.ID_KHACH_HANG = KH.ID_KHACH_HANG  ");

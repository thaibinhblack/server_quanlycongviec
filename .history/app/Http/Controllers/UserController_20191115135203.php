...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $users = DB::select("SELECT ID_ND, USERNAME_ND from TB_NGUOI_DUNG");
    ...
    public function token(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            $user = DB::select("SELECT ID_ND, USERNAME_ND from TB_NGUOI_DUNG where TOKEN_ND = '$token';");
    ...
    public function login(Request $request)
    {
        ...
        {
            $username  = $request->get("USERNAME");
            $result = DB::select("SELECT PASSWORD_ND from TB_NGUOI_DUNG where TOKEN_ND = '$username'");
            if($result)
            {

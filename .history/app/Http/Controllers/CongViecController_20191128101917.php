    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            if($request->has('trang_thai'))
            {
                ...
                $cv = DB::select("SELECT CVDA.*, ND.username_nd FROM TB_CONG_VIEC_DA CVDA, TB_NGUOI_DUNG ND where CVDA.nguoi_giao_viec = ND.id_nd and nguoi_nhan_viec = '$id_nd' and CVDA.trang_thai = $trang_thai ");

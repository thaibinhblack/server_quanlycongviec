...
class UserController extends Controller
{
    ...
    public function resignter(Request $request)
    {
        ...
        if($validate)
        {
            ...
            $resignter = $pdo->prepare("select THEM_TK_TB_ND('123123123','$2y$10$6M.ik7pD3JCJAyMJ2Tndh.F3JFdqrpL5N4OCBUfIT/6nbgvwEHqKG') from dual;");
            return response()->json($resignter>execute(), 200);

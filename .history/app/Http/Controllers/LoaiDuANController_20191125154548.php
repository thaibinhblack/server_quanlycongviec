...
class LoaiDuANController extends Controller
{
    ...
    public function CallFunction($P_ID_DU_AN, $P_TEN_DU_AN, $P_MO_TA_DU_AN, $P_GHI_CHU_DU_AN, $P_TRANG_THAI_DU_AN, $P_ACTION)
    {
        $sql = "DECLARE
            ...
            P_ACTION NUMBER(1);
        BEGIN
            :n := THEM_CAPNHAT_DU_AN(:P_ID_DU_AN,:P_TEN_DU_AN, :P_MO_TA_DU_AN, :P_GHI_CHU_DU_AN, :P_TRANG_THAI_DU_AN,:P_ACTION);
        END;";  
        $pdo = DB::getPdo();
    ...
    public function index(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            $loai_du_an = DB::SELECT("SELECT * FROM TB_DA");
    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            if($request->has('api_token'))
            {
                ...
                $P_ACTION = 1;
                $result = $this->CallFunction($P_ID_DU_AN, $P_TEN_DU_AN, $P_MO_TA_DU_AN, $P_GHI_CHU_DU_AN, $P_TRANG_THAI_DU_AN, $P_ACTION);

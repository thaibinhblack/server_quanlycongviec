...
class NhomController extends Controller
{
    ...
    public function CallFunction($p_id_tt, $p_ten_nhom, $p_trang_thai_nhom, $p_ghi_chu_nhom, $p_mo_ta_nhom,$action,$id)
    {
        $pdo = DB::getPdo();
        $sql = "DECLARE
        ...
        $stmt->bindParam(':p_kiem_tra_action',$action);
        $stmt->bindParam(':p_id_nhom',$id);
    ...
    public function store(Request $request)
    {
        ...
        if($validate)
        {
            ...
            $result = $this->CallFunction($p_id_tt, $p_ten_nhom, $p_trang_thai_nhom, $p_ghi_chu_nhom, $p_mo_ta_nhom,1,0);

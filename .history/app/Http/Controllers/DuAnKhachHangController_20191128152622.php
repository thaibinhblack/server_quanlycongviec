        ...
        if($validate)
        {
            if($request->has('api_token'))
            {
                ...
                if($result)
                {
                    ...
                    $this->CallFunctionQuyen(0,$user[0]->id_nd, $ID_DU_AN_KH[0]->ID_DU_AN_KH, $ID_DU_AN_KH[0]->ID_DU_AN_KH.'.1', $ID_DU_AN_KH[0]->ID_DU_AN_KH.'.1', $ID_DU_AN_KH[0]->ID_DU_AN_KH.'.1', $ID_DU_AN_KH[0]->ID_DU_AN_KH.'.1', $ID_DU_AN_KH[0]->ID_DU_AN_KH.'.1' );

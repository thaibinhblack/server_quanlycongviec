...
class CustomerController extends Controller
{
    public function CallFunction()
    {
        $sql = "DECLARE
            ...
            p_action number(1);
        BEGIN
            :result := THEM_KH(:p_ten_kh,:p_dia_chi_kh,:p_sdt_kh,:p_nguoi_dai_dien,:p_trang_thai_kh, :p_action);
        END;";
    ...
    public function store(Request $request)
    {
        if($request->has('api_token'))
        {
            ...
            if($validate)
            {
                ...
                $p_action = 1;
                $this->CallFunction($p_id_khach_hang, $p_ten_kh, $p_dia_chi_kh, $p_sdt_kh, $p_nguoi_dai_dien, $p_trang_thai_kh, $p_action);
                return response()->json([
                    'success' => true,

...
class CongViecController extends Controller
{
    ...
    public function chitiet(Request $request)
    {
        $sql = "DECLARE
            ...
            P_ACTION number(1);
        BEGIN
            :result := THEM_CAPNHAT_KH(:P_ID_DU_AN_KH,:P_ID_CV_DA,:P_ACTION);
        END;";
        $P_ID_CV_DA = $request->get('P_ID_DU_AN_KH');
        $P_ID_DU_AN_KH = $request->get('P_ID_CV_DA');
        $P_ACTION = 1;
        $array = explode(',', $P_ID_CV_DA);

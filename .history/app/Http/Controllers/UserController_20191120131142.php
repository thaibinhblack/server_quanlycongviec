...
class UserController extends Controller
{
     ...
     */
    public function CallFunction($username, $password, $p_id_nhom, $p_email, $p_gt, $p_ngaysinh, $p_action)
    {
        $sql = "DECLARE
    ...
    public function resignter(Request $request)
    {
        ...
        if($validate)
        {
            ...
            $result = $this->CallFunction($username, $password, $p_id_nhom, $p_email, $p_gt, $p_ngaysinh, 1);
            if($result == 1)
            {
    ...
    public function update(Request $request, $id)
    {
        if($request->has('api_token'))
        {
            ...
            if($validate)
            {
                ...
                $result = $this->CallFunction($username, $password, $p_id_nhom, $p_email, $p_gt, $p_ngaysinh, 2);
                if($result == 2)
                {
                    return response()->json([
                        'success' => true,

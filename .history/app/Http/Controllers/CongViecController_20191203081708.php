...
class CongViecController extends Controller
{
    ...
    )
    {
     $sql = "DECLARE
        ...
        RESULT_CV OUT NUMBER(10);
    BEGIN
        :n := THEM_CAPNHAT_CONGVIEC(:P_ID_CV_DA, :P_ID_DU_AN_KH, :P_TEN_CV, :P_NOI_DUNG_CV, :P_NGAY_TIEP_NHAN,:P_NGAY_HOAN_THANH, :P_NGAY_CAM_KET, :P_GIO_THUC_HIEN, :P_DO_UU_TIEN, 
    ...
    $stmt->bindParam(':P_ID_DU_AN_KH',$P_ID_CV_DA);

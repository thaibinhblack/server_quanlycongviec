...
//loại dự án
Route::get('du-an','LoaiDuANController@index')->middleware('cors');
Route::post('du-an','LoaiDuANController@store')->middleware('cors');
Route::post('du-an/{id}','LoaiDuANController@update')->middleware('cors');

// dự án
Route::get("du-an-kh",'DuAnController@index')->middleware('cors');
Route::post("du-an-kh",'DuAnController@store')->middleware('cors');
Route::post("du-an-kh/{id}",'DuAnController@update')->middleware('cors');

// nhân viên tham gia dự án
Route::post('du-an-nv','NhanVienDuAnController@store')->middleware('cors');
